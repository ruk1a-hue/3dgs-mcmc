...
```powershell
<PYTHON> train.py --source_path "<DATA_ROOT>\tandt_db\tandt\train" --model_path "<REPO_ROOT>\output\step5\train_h1_delayed_edge" --config configs\train_step5_h1_delayed_edge.json --eval --seed 0
```

```powershell
<PYTHON> render.py --model_path "<REPO_ROOT>\output\step5\train_h1_delayed_edge" --iteration 30000 --skip_train
<PYTHON> metrics.py --model_paths "<REPO_ROOT>\output\step5\train_h1_delayed_edge"
```
