...
EXP = {
    ...
    "model": r"D:\AI WORK\3dgs-mcmc-step4-improvements\output\step5\train_h1delayed_h2_systematic_80cap",
    "config": r"configs\train_step5_h1delayed_h2_systematic_80cap.json",
}
