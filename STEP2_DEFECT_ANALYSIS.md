...
| File | Purpose |
|---|---|
| `D:\AI WORK\3dgs-mcmc-main\results\step2_evidence\per_view_summary.csv` | Mean/std/min/max per-view metric summary. |
| `D:\AI WORK\3dgs-mcmc-main\results\step2_evidence\mic_per_view_metrics_sorted.csv` | `mic` per-view metrics sorted by quality. |
| `D:\AI WORK\3dgs-mcmc-main\results\step2_evidence\train_per_view_metrics_sorted.csv` | `train` per-view metrics sorted by quality. |
| `D:\AI WORK\3dgs-mcmc-main\results\step2_evidence\train_worst_views_panel.png` | GT/render/error visualization for the worst `train` views. |
| `D:\AI WORK\3dgs-mcmc-main\results\step2_evidence\config_capmax_summary.csv` | Scene-specific `cap_max` values from official configs. |
